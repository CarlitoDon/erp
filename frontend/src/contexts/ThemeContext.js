...
import { createTheme, ThemeProvider as MuiThemeProvider, alpha } from "@mui/material/styles"; // Import alpha
    ...
    () =>
      createTheme({
        ...
        components: {
              ...
              root: ({ ownerState, theme }) => ({
                ...
                ...(ownerState.variant === 'contained' && ownerState.color === 'primary' && {
                 ...
                 ...(ownerState.variant === 'outlined' && ownerState.color === 'secondary' && {
                     ...
                     '&:hover': {
                         backgroundColor: alpha(theme.palette.secondary.main, theme.palette.action.hoverOpacity), // Background hover abu-abu lembut
                         borderColor: theme.palette.secondary.dark || theme.palette.secondary.main, // Border hover sedikit lebih gelap jika ada
                         color: theme.palette.secondary.dark || theme.palette.secondary.main, // Teks hover sedikit lebih gelap jika ada
                     },
                 }),
          ...
          MuiTextField: { // Style MuiTextField tetap sama
            defaultProps: {
              variant: "outlined",
              fullWidth: true,
            },
          ...
          MuiFormControlLabel: { // Style MuiFormControlLabel tetap sama
            styleOverrides: {
              label: {
                fontSize: "0.875rem",
              },
          ...
          MuiCheckbox: { // Style MuiCheckbox tetap sama
            styleOverrides: {
              root: {
